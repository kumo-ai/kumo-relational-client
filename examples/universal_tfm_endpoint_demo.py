...
def run_high_level_prediction(base_url: str, api_key: str) -> None:
    print('\n=== SDK KumoRFM.predict(...) ===')
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--api-key',
        default=os.getenv('KUMO_API_KEY', 'test:DISABLED'),
        help='API key header value. Default: KUMO_API_KEY or test:DISABLED.',
    )
    parser.add_argument(
        '--timeout',
        type=float,
