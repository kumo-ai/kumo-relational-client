---
title: "NVIDIA Nemotron Predict Client Documentation"
description: "Overview of the NVIDIA Nemotron Predict Client, the Python client for structured-data foundation model NIMs served behind the Universal TFM API."
template-library-version: "1.0.0"
---

# NVIDIA Nemotron Predict Client Documentation

The NVIDIA Nemotron Predict Client is one Python client for
...
- To install the client, refer to [Installation Guide for the NVIDIA Nemotron Predict Client](../get-started/installation.md).
- To run your first prediction, refer to [Quickstart for the NVIDIA Nemotron Predict Client](../get-started/quickstart.md).
- To understand how the client is put together, refer to [NVIDIA Nemotron Predict Client Architecture](architecture.md).
- To look up configuration, refer to [NVIDIA Nemotron Predict Client Environment Variables](../reference/environment-variables.md).
...
| --- | --- | --- |
| Client client | `nemotron-predict-client` | The `PredictClient`, typed requests, and per-model adapters. Pure Python. |
...
- [NVIDIA Nemotron Predict Client Architecture](architecture.md)
