...
from nvidia_sdfm import SDFMClient, SdfmError
from nvidia_sdfm.core.transport import Transport, redact_url, scrub_userinfo
...
def test_the_url_stays_readable_through_the_property():
    # Redaction covers what is rendered, not what is stored: the KumoRFM
...
def test_client_repr_does_not_render_a_credential_carried_in_the_url():
    with SDFMClient(_URL) as client:
