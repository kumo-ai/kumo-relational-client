...
class Graph:
    ...
    def from_sqlite(
        ...
        Args:
            connection: An open connection from
                :meth:`~kumorfm.rfm.backend.sqlite.connect` or the
            ...
            verbose: Whether to print verbose output.
        """
        from kumorfm.rfm.backend.sqlite import Connection, SQLiteTable, connect
    ...
    def from_duckdb(
        ...
        Args:
            connection: An open connection from
                :meth:`~kumorfm.rfm.backend.duckdb.connect`, the path to the
            ...
            verbose: Whether to print verbose output.
        """
        from kumorfm.rfm.backend.duckdb import Connection, DuckDBTable, connect
    ...
    def from_databricks(
        ...
        Args:
            connection: An open connection from
                :meth:`~kumorfm.rfm.backend.databricks.connect` or the
            ...
            verbose: Whether to print verbose output.
        """
        from kumorfm.rfm.backend.databricks import (
            Connection,
            DatabricksTable,
            connect,
        )
    ...
    def infer_metadata(self, verbose: bool = True) -> Self:
        ...
        Note:
            ...
            :meth:`kumorfm.rfm.Table.infer_metadata`.
        """
    ...
    def validate(self) -> Self:
        ...
        in an :class:`~kumorfm.graph.Edge` are of the same data type.
