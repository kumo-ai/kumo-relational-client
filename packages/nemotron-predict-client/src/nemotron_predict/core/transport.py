...
def redact_url(url: str | None) -> str | None:
    ...
    credential on the NemotronRelational path. The two cannot share one implementation:
...
class Transport:
    ...
    failures (429/5xx). Not part of the public API surface; a ``PredictClient``
    holds one of these.
    ...
    def _post(self, path: str, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            # RuntimeError and would otherwise escape the PredictError contract.
