...
import nemotron_predict.core.connectors as connectors_module
from nemotron_predict.core.connectors import read
...
def test_missing_backend_maps_to_missing_extra_error(
    ...
    from nemotron_predict_connectors.sql import MissingBackendError
    ...
    assert f'nemotron-predict-client[{extra}]' in str(excinfo.value)
