...
import nemotron_structured.core.connectors as connectors_module
from nemotron_structured.core.connectors import read
...
def test_missing_backend_maps_to_missing_extra_error(
    ...
    assert f'nemotron-structured-client[{extra}]' in str(excinfo.value)
