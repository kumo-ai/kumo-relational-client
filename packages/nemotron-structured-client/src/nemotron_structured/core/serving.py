...
:class:`~nemotron_structured.core.transport.Transport` speaks HTTP to a NIM at a base
...
one of them refuses: each raises an :class:`StructuredError` naming the endpoint and
...
class ServingTarget:
    ...
    def _require_open(self) -> None:
        r"""Part of the transport contract ``StructuredClient._predict`` relies on.
