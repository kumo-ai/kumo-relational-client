...
from kumo_relational_engine.api.common import ValidationResponse
...
from kumo_relational_engine.api.pquery.utils import QueryType, maybe_bold
...
class ParsedPredictiveQuery:
    ...
    Args:
        ...
        rfm_query: :obj:`True` if this is a query from KumoRelational.
