...
from kumo_relational_engine.api.rfm import RFMPredictRequest
from kumo_relational_engine.api.rfm.context import REV_REL, Context, EdgeLayout
from kumo_relational_engine.api.rfm.inference import (
...
def validate_payload_table_rows(
    ...
    *,
    ...
    The KumoRelational NIM row-caps only context/predict instance tables. Related
