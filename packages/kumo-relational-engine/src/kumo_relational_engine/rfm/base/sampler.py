...
from kumo_relational_engine.api.pquery.AST import Aggregation, ASTNode
from kumo_relational_engine.api.rfm.context import (
    EdgeLayout,
    Link,
    Subgraph,
    Table,
...
class Sampler(ABC):
    ...
    def sample_lagged_target(
        ...
        for i in range(lag_timesteps)[::-1]:
            ...
            y_lag_dict[f'__kumo_arl{lag_timesteps - 1 - i}__'] = y_lag
