...
from kumo_relational_engine.client.client import capped_body
from kumo_relational_engine.client.transport import TransportResponse
...
def raise_on_error(response: TransportResponse) -> None:
    r"""Raises an :class:`~kumo_relational_engine.exceptions.HTTPException` if a response does
