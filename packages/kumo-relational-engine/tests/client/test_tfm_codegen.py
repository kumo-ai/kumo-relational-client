...
from kumo_relational_engine.client.endpoints import HTTPMethod
...
from kumo_relational_engine.client.rfm import (
...
def test_generated_tfm_api_matches_local_canonical_spec() -> None:
    ...
    output = Path('src/kumo_relational_engine/client/generated/tfm_api.py')
