...
import pytest
from kumo_relational_engine.rfm import explain_summary
from kumo_relational_engine.rfm.explain_summary import (
...
requires_openai = pytest.mark.skipif(
    not _HAS_OPENAI,
    reason='openai (kumo_relational_engine[explain]) is not installed',
)
...
def test_explain_config_docstring_discloses_the_egress() -> None:
    from kumo_relational_engine.rfm import ExplainConfig
...
def test_nim_failure_error_explain_reports_gpu_pressure() -> None:
    ...
    from kumo_relational_engine.rfm.rfm import _nim_failure_error
...
def test_high_cardinality_columns_reports_worst_first_and_dedupes() -> None:
    from kumo_relational_engine.rfm.payload import high_cardinality_columns
