...
from nemotron_relational import (
    in_jupyter_notebook,
    in_streamlit_notebook,
    in_tmux,
)
from nemotron_relational.api.graph import (
    ColumnKey,
    ColumnKeyGroup,
    GraphDefinition,
)
from nemotron_relational.api.table import TableDefinition
from nemotron_relational.api.typing import Stype
from nemotron_relational.exceptions import (
    GraphConstructionError,
    NemotronRelationalError,
)
from nemotron_relational.graph.graph import Edge, EdgeLike
from nemotron_relational.mixin import CastMixin
from nemotron_relational.rfm.base import (
    Column,
    ColumnSpec,
    DataBackend,
    Table,
...
from nemotron_relational.rfm.base.utils import Timedelta
from nemotron_relational.rfm.infer import infer_time_column
from nemotron_relational.utils import display, quote_ident
...
def _reraise_as_graph_error(error: BaseException, source: str) -> None:
    ...
    """
    if isinstance(error, NemotronRelationalError | Warning):
        return
...
class Graph:
    ...
    is created, use it to initialize :class:`NemotronRelational`.
    ...
    def from_data(
        ...
        Args:
            ...
            edges: An optional list of :class:`~nemotron_relational.graph.Edge` objects to
    ...
    def from_sqlite(
        ...
        Args:
            connection: An open connection from
                :meth:`~nemotron_relational.rfm.backend.sqlite.connect` or the
            ...
            edges: Optional edge-like objects to add to the graph. Each item
                may be a :class:`~nemotron_relational.graph.Edge`, a dictionary, or a tuple
            ...
            verbose: Whether to print verbose output.
        """
        from nemotron_relational.rfm.backend.sqlite import (
            Connection,
            SQLiteTable,
            connect,
        )
    ...
    def from_duckdb(
        ...
        Args:
            connection: An open connection from
                :meth:`~nemotron_relational.rfm.backend.duckdb.connect`, the path to the
    ...
    def from_snowflake(
        ...
        Args:
            connection: An open connection from
                :meth:`~nemotron_relational.rfm.backend.snow.connect` or the
            ...
            verbose: Whether to print verbose output.
        """
        from nemotron_relational.rfm.backend.snow import (
            Connection,
            SnowTable,
            connect,
            paramstyle,
    ...
    def from_databricks(
        ...
        Args:
            connection: An open connection from
                :meth:`~nemotron_relational.rfm.backend.databricks.connect` or the
    ...
    def from_databricks_metric_view(
        ...
        from nemotron_relational.rfm.backend.databricks.metric_view import (
            SOURCE_ALIAS,
    ...
    def from_relbench(
        ...
        Args:
            ...
            verbose: Whether to print verbose output.
        """
        from nemotron_relational.rfm.relbench import from_relbench
    ...
    def graph_and_pquery_from_timeseries(
        ...
        * A target table - one row per observation, with a foreign-key to
        ...
        .. code-block:: python
            ...
            >>> model = rfm.NemotronRelational(graph)
        ...
        Args:
            ...
            anchor_time: The forecast cutoff timestamp.  Required when
                ...
                :meth:`NemotronRelational.predict` as ``anchor_time``.
        ...
        Returns:
            ...
            ready for use with :class:`NemotronRelational` and *pquery* is a
            predictive-query string for single-step forecasting.  Pass
            *pquery* to :meth:`NemotronRelational.predict` together with ``anchor_time``
    ...
    def infer_metadata(self, verbose: bool = True) -> Self:
        ...
        Note:
            ...
            :meth:`nemotron_relational.rfm.Table.infer_metadata`.
        """
        for table in self.tables.values():
    ...
    def unlink(
        ...
        r"""Removes an :class:`~nemotron_relational.graph.Edge` from the graph.
    ...
    def validate(self) -> Self:
        ...
        in an :class:`~nemotron_relational.graph.Edge` are of the same data type.
    ...
    def visualize(
        ...
        """
        from nemotron_relational.rfm import viz
    ...
    def update_connection(
        ...
        for table in self.tables.values():
            ...
            if table.backend == DataBackend.SNOWFLAKE:
                ...
                from nemotron_relational.rfm.backend.snow import SnowTable
