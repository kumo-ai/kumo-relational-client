...
from nemotron_relational.api.rfm.context import Subgraph
from nemotron_relational.rfm.backend.local import LocalTable
from nemotron_relational.rfm.base import Table
from nemotron_relational.rfm.diagnostics import (
...
class LocalGraphStore:
    ...
    def get_csc(
        ...
        for src_table, fkey, dst_table in graph.edges:
            ...
            if len(dst) > 0 and src_table in self.time_dict:
