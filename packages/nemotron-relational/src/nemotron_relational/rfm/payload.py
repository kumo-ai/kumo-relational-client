...
from nemotron_relational.api.rfm.context import REV_REL, Context, EdgeLayout
from nemotron_relational.api.rfm.inference import (
...
ENTITY_REFERENCE_PREFIX = '__nemotron_entity_ref'
ANCHOR_TIME_PREFIX = '__nemotron_anchor_time'
...
def validate_payload_table_rows(
    ...
    *,
    ...
    The NemotronRelational NIM row-caps only context/predict instance tables. Related
...
def _base_payload(
    *,
    ...
    return {
        'model': TFM_MODEL_KUMO_RELATIONAL,
