...
from nemotron_relational.api.graph import GraphDefinition
from nemotron_relational.api.pquery import ValidatedPredictiveQuery
from nemotron_relational.rfm.base import composite_key
...
def parse_query_locally(
    ...
    try:
        ...
        from nemotron_relational.pql.validator import PredictiveQueryValidator
