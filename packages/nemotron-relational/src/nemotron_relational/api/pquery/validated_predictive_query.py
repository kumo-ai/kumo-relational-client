...
from nemotron_relational.api.common import ValidationResponse
...
from nemotron_relational.api.pquery.utils import QueryType, maybe_bold
...
class ParsedPredictiveQuery:
    ...
    Args:
        ...
        rfm_query: :obj:`True` if this is a query from NemotronRelational.
