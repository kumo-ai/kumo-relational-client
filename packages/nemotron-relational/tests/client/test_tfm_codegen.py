...
def test_generated_tfm_api_runtime_metadata() -> None:
    ...
    assert TFM_MODEL_NEMOTRON_RELATIONAL_V1 == 'nemotron-relational-v1'
...
def test_generated_prediction_response_parser() -> None:
    ...
    assert response.model == 'nemotron-relational-v1'
...
def _assert_request_envelope_shape(value: dict) -> None:
    assert value['model'] in {'tabicl', 'nemotron-relational-v1'}
            ...
            'schemas': {
                'PredictionRequest': {
                    ...
                    'properties': {
                        ...
                        'model': {
                            'enum': ['tabicl', 'nemotron-relational-v1'],
                        },
                        'task': {},
                        'schema': {},
                        'context': {},
